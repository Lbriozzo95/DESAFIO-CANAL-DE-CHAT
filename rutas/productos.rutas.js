...
productos.items.push(new Producto ("campera oc by kanu", 4800, "./img.png"))
productos.items.push(new Producto ("mallas by flor",1200, "./img2.png"))
productos.items.push(new Producto ("bufanda by pauqndt", 600, "./img3.png"))
